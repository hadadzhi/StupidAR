...
const AMOVIESETUP_FILTER kSetupFilter = { &kMyFilterGuid, kMyFilterName, MERIT_DO_NOT_USE, _countof(kSetupPins), kSetupPins };
...
CUnknown* WINAPI CreateFilter(IUnknown* pUnknown, HRESULT* pResult) {
	...
	auto pInstance = new(std::nothrow) StupidAudioRenderer(pUnknown, pResult);
...
CFactoryTemplate g_Templates[] = {
	{ kMyFilterName, &kMyFilterGuid, CreateFilter, nullptr, &kSetupFilter }
};
